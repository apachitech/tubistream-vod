...
export const FastLiveGuide: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '32px 24px', minHeight: '80vh' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
          ...
          />
          <h1 style={{ fontSize: '2.2rem', fontWeight: 900, color: '#fff' }}>24/7 Live FAST TV Channels</h1>
        </div>
